...
# main output folder
main_output_folder = "/scratch-shared/edwinsut/data_for_flore/M08/" + str(sta_year) + "_to_" + str(end_year) + "/"
# - prepare the directory
if os.path.exists(main_output_folder) == False: os.makedirs(main_output_folder)

# location of netcdf input files
pcrglobwb_output_folder = "/scratch-shared/edwin/05min_runs_for_gmd_paper_30_oct_2017/05min_runs_4LCs_accutraveltime_cru-forcing_1958-2015/non-natural_starting_from_1958/begin_from_1958/M08/netcdf/"
